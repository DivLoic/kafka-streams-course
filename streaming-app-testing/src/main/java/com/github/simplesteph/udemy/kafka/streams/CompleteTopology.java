...
public class CompleteTopology {

    private static Logger logger = LoggerFactory.getLogger(CompleteTopology.class);
    ...
    public static void main(String[] args) {
        ...
        config.put(StreamsConfig.APPLICATION_ID_CONFIG, "favourite-player-java");
