...
import io.confluent.kafka.streams.serdes.avro.{GenericAvroDeserializer, GenericAvroSerde, GenericAvroSerializer, SpecificAvroSerde}
...
object GenericAvroEventScalaApp extends App {
  ...
  config.put(StreamsConfig.APPLICATION_ID_CONFIG, "generic-avro-app-scala")
