...
object ArcadeContestExactlyOnceAppScala extends App with Generator {
  ...
  config.put(StreamsConfig.APPLICATION_ID_CONFIG, "arcade-contest-scala-app")
  ...
  challengersLifePoints.toStream.to("arcade-contest-exactly-once-scala")(Produced.`with`(Serdes.String, jsonSerde))
