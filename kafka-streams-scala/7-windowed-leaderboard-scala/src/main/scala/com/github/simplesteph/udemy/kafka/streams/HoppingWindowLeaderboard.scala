...
object HoppingWindowLeaderboard extends App {
  ...
  properties.put(StreamsConfig.APPLICATION_ID_CONFIG, "hopping-window-scala-app")
  ...
  victories
    ...
    .to("hopping-window-victories-scala")(Produced.`with`(windowedStringSerde, victoriesSerde))
