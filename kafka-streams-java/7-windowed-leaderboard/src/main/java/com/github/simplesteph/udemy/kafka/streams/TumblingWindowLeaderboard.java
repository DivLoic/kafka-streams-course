...
public class TumblingWindowLeaderboard {
    ...
    public static void main(String[] args) {
        ...
        properties.put(StreamsConfig.APPLICATION_ID_CONFIG, "tumbling-window-app");
        ...
        victories
                ...
                .mapValues(TumblingWindowLeaderboard::moveWindowStartToValue)

                .to("tumbling-window-victories", Produced.with(windowedSerde, victoriesSerde));
