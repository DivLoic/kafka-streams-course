...
public class FailureMonitoring {
    ...
    public static void main(String[] args) {
        ...
        victories
                ...
                .map((key, value) -> {
                    Instant statingBound =  key.window().startTime();
                    ZonedDateTime startingTime = statingBound.atZone(ZoneId.systemDefault());
                    value.setWindowStart(startingTime.format(fmt));
