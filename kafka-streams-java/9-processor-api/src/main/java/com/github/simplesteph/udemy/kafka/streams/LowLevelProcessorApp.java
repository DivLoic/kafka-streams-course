...
public class LowLevelProcessorApp {
    ...
    public static void main(String[] args) {
        ...
        KStream<MachineId, Victory> victories = builder.stream("processor-victories", consumed);
        ...
        victories
                ...
                .to("processor-rewarded-victories", Produced.with(machineIdSerde, rewardedVictorySerde));
